...
Ajout local du 21 septembre 2026, non publié : [le bazooka RPG](bazooka.md) utilise un modèle polygonal facetté original créé dans le style de l'AK-47 et de l'AWP. Sa silhouette et sa palette approuvées sont préservées. Le même OBJ/MTL sert en FPS et sur les personnages distants : 1 176 triangles, 656 sommets OBJ indexés, neuf matériaux, dont une lentille à 12 % d'opacité. Sa longueur reste 2,375 blocs. L'ogive olive séparée, `RPG_rocket`, utilise ses 280 triangles d'origine sur le lanceur et en vol. Elle disparaît du lanceur au tir, puis revient au terme de la cadence de 62 ticks.
