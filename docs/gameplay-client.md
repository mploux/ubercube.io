...
Publié le 22 septembre 2026 : [compensation historique des impacts AK/AWP](lag-compensation.md), bornée à 250 ms, avec prise en compte des couvertures et du dernier échantillon affiché. Client et serveur utilisent le protocole 8. L'interpolation et le maniement restent identiques ; RPG, grenades, pelle et médic conservent leurs règles.
